  ...
  return (
    <div className="max-w-[390px] mx-auto bg-[#0D1117] min-h-screen flex flex-col">
      ...
      <div className="relative bg-[#13192A] px-5 pt-12 pb-8 text-center">
        ...
        <p style={{ color: '#005EB8', fontSize: '48px', fontWeight: '900', letterSpacing: '4px', fontStyle: 'italic', marginBottom: '4px' }}>DOOSAN</p>
        <p style={{ color: 'white', fontSize: '14px', letterSpacing: '6px' }}>TREKKING</p>
